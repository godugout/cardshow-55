  ...
  return (
    <div className={`items-center bg-crd-darkest flex w-full flex-col overflow-hidden text-center pt-32 ${isMobile ? 'px-5' : 'px-[200px]'} max-md:max-w-full max-md:pt-[100px] ${className}`}>
      <div className="flex w-full max-w-[900px] flex-col items-center max-md:max-w-full">
        ...
        {/* Featured Cards Ticker Carousel - Full Width */}
      ...
      {showFeaturedCards && featuredCards.length > 0 && (
        <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] mb-12 overflow-hidden">
          {/* Gradient Overlays */}
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-crd-darkest via-crd-darkest/80 to-transparent z-10 pointer-events-none" />
      ...
      {/* Continue with CTA inside container */}
      <div className="flex w-full max-w-[900px] flex-col items-center max-md:max-w-full">
        {/* Primary CTA */}
        <Link to={ctaLink}>
          <CRDButton 
