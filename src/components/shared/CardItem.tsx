...
export const CardItem: React.FC<CardItemProps> = ({
  ...
  return (
    <>
      <div 
        className="self-stretch flex min-w-60 flex-col items-stretch justify-center grow shrink w-[205px] my-auto cursor-pointer hover:transform hover:scale-105 transition-transform duration-200"
        onClick={handleClick}
      >
