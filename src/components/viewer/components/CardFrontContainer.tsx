...
import { CardFrontVisibilityManager } from './CardFrontVisibilityManager';
...
export const CardFrontContainer: React.FC<CardFrontContainerProps> = ({
  ...
  return (
    <CardFrontVisibilityManager rotation={rotation} solidCardTransition={solidCardTransition}>
      {({ opacity: frontOpacity, zIndex: frontZIndex }) => (
        <div 
