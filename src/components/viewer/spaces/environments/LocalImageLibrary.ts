...
// Using reliable, CORS-enabled 360° images
export const LOCAL_360_IMAGES: Local360Image[] = [
  // Natural Environments
  {
    ...
    category: 'natural',
    localUrl: '/360-images/forest-clearing.jpg',
  ...
  },
  {
    ...
    name: 'Mountain Vista',
    category: 'natural',
    localUrl: '/360-images/mountain-vista.jpg',
  ...
  },
  {
    ...
    name: 'Ocean Sunset',
    category: 'natural',
    localUrl: '/360-images/ocean-sunset.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1505142468610-359e7d316be0?w=2048&h=1024&fit=crop',
  ...
  // Urban Environments
  {
    ...
    name: 'City Rooftop',
    category: 'urban',
    localUrl: '/360-images/city-rooftop.jpg',
  ...
  },
  {
    ...
    name: 'Neon City',
    category: 'urban',
    localUrl: '/360-images/neon-city.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=2048&h=1024&fit=crop',
  ...
  // Interior Spaces
  {
    ...
    name: 'Modern Studio',
    category: 'interior',
    localUrl: '/360-images/modern-studio.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=2048&h=1024&fit=crop',
  ...
  },
  {
    ...
    name: 'Warehouse Loft',
    category: 'interior',
    localUrl: '/360-images/warehouse-loft.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=2048&h=1024&fit=crop',
  ...
  // Sports Venues
  {
    ...
    name: 'Sports Arena',
    category: 'sports',
    localUrl: '/360-images/sports-arena.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=2048&h=1024&fit=crop',
  ...
  // Cultural Spaces
  {
    ...
    name: 'Concert Hall',
    category: 'cultural',
    localUrl: '/360-images/concert-hall.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=2048&h=1024&fit=crop',
  ...
  // Fantasy Environments
  {
    ...
    name: 'Cosmic Void',
    category: 'fantasy',
    localUrl: '/360-images/cosmic-void.jpg',
    fallbackUrl: 'https://images.unsplash.com/photo-1446776877081-d282a0f896e2?w=2048&h=1024&fit=crop',
