        ...
        <div className="space-y-6">
          ...
          {authLoading ? (
            <div className="text-center py-8">
              <div className="w-8 h-8 border-2 border-crd-blue border-t-transparent rounded-full animate-spin mx-auto mb-4" />
              <p className="text-crd-white">Checking authentication...</p>
            </div>
          ) : !user ? (
            <div className="text-center py-8">
              <div className="w-16 h-16 mx-auto mb-4 bg-crd-orange/10 rounded-full flex items-center justify-center">
                <AlertCircle className="w-8 h-8 text-crd-orange" />
              </div>
