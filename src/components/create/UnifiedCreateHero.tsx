  ...
  const renderTabletHeroText = () => (
    <div className="text-center max-w-4xl mx-auto">
      ...
      <h1 className="leading-tight mb-8 font-light">
        <div className="text-lg md:text-xl lg:text-2xl text-gray-400 mb-2 whitespace-nowrap">
        ...
        <div className="text-xl md:text-3xl lg:text-4xl font-bold whitespace-nowrap">
