...
import type { DisplayCard } from '@/components/cards/types/DisplayCard';
...
export const ProfileTabs = ({ 
  ...
  // Convert memories that look like cards to DisplayCard format
  const cards: DisplayCard[] = memories
