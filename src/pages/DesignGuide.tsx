...
const DesignGuide = () => {
  ...
  const logoVariants = [
    { name: 'Cardshow Official', component: <CardshowGreenSparklesOfficialLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Primary brand mark with sparkles - Official Cardshow logo', context: 'Main brand applications, hero sections, official materials', theme: { primary: '#45B26B', secondary: '#FFD700', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'CRD Gradient', component: <CRDGradientLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Technical brand mark for development tools', context: 'CRD maker, developer tools, technical documentation', theme: { primary: '#3772FF', secondary: '#9757D7', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Green Script', component: <CardshowGreenScriptLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Elegant script version for premium contexts', context: 'Luxury collections, premium features, elegant presentations', theme: { primary: '#45B26B', secondary: '#FFD700', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Brown Orange', component: <CardshowBrownOrangeLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Warm, vintage appeal for retro themes', context: 'Vintage collections, heritage features, classic designs', theme: { primary: '#8B4513', secondary: '#FF8C00', accent: '#FFE4B5', text: '#FFFFFF' } },
    { name: 'Blue Outline', component: <CardshowBlueOutlineLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Clean outline version for professional use', context: 'Corporate communications, business materials, clean layouts', theme: { primary: '#3772FF', secondary: '#FFD700', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Teal Sparkles', component: <CardshowTealSparklesLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Modern premium with magical elements', context: 'Special events, premium features, modern aesthetics', theme: { primary: '#008B8B', secondary: '#FFD700', accent: '#000000', text: '#FFFFFF' } },
    { name: 'Red Script', component: <CardshowRedScriptLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Bold script for high-energy contexts', context: 'Action features, dynamic content, high-energy themes', theme: { primary: '#DC143C', secondary: '#000000', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Black Bold', component: <CardshowBlackBoldLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Strong, minimalist version', context: 'Modern minimalist designs, high contrast needs', theme: { primary: '#000000', secondary: '#FFFFFF', accent: '#808080', text: '#FFFFFF' } },
    { name: 'Purple Outline', component: <CardshowPurpleOutlineLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Premium outline version', context: 'Luxury branding, premium tier features, elegant designs', theme: { primary: '#9757D7', secondary: '#FFFFFF', accent: '#FFD700', text: '#FFFFFF' } },
    { name: 'Orange Black Bold', component: <CardshowOrangeBlackBoldLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'High-contrast bold version', context: 'Sports themes, high-energy content, bold statements', theme: { primary: '#FF8C00', secondary: '#000000', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Cardshow Basic', component: <CardshowBasicLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Clean, minimal version for professional contexts', context: 'Documentation, business materials, partnerships', theme: { primary: '#3772FF', secondary: '#FFFFFF', accent: '#000000', text: '#FFFFFF' } },
    { name: 'Cardshow Blue', component: <CardshowBlueLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Trust and reliability messaging', context: 'Corporate communications, enterprise features', theme: { primary: '#3772FF', secondary: '#FFFFFF', accent: '#000000', text: '#FFFFFF' } },
    { name: 'Cardshow Orange', component: <CardshowOrangeLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Energy and creativity themes', context: 'Creator tools, community features, calls-to-action', theme: { primary: '#EA6E48', secondary: '#000000', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Cardshow Modern', component: <CardshowModernLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Contemporary, tech-forward messaging', context: 'Innovation showcases, product launches', theme: { primary: '#3772FF', secondary: '#9757D7', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Cardshow Retro', component: <CardshowRetroLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Nostalgic, vintage card collecting appeal', context: 'Heritage features, collector community', theme: { primary: '#8B4513', secondary: '#FFD700', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Cardshow Vintage', component: <CardshowVintageLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Classic elegance and timeless quality', context: 'Premium offerings, luxury collections', theme: { primary: '#8B4513', secondary: '#FFE4B5', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Cardshow Red Blue', component: <CardshowRedBlueLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Patriotic themes and American sports', context: 'Sports partnerships, team collaborations', theme: { primary: '#DC143C', secondary: '#0000FF', accent: '#FFFFFF', text: '#FFFFFF' } },
    { name: 'Block Letters', component: <CardshowBlockLettersLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Bold, impactful messaging', context: 'Headlines, promotional materials, merchandise', theme: { primary: '#000000', secondary: '#FFFFFF', accent: '#808080', text: '#FFFFFF' } },
    { name: 'Cardshow Green', component: <CardshowGreenLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Growth, success, and environmental themes', context: 'Sustainability messaging, creator economy', theme: { primary: '#45B26B', secondary: '#FFFFFF', accent: '#000000', text: '#FFFFFF' } },
    { name: 'Green Sparkles', component: <CardshowGreenSparklesLogo className="max-w-32 max-h-32 lg:max-w-48 lg:max-h-48 w-auto h-auto object-contain" />, usage: 'Magical, premium experiences', context: 'Special events, premium features, celebrations', theme: { primary: '#45B26B', secondary: '#FFD700', accent: '#FFFFFF', text: '#FFFFFF' } },
  ];
