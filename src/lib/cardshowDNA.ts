...
export const CRD_DNA_ENTRIES: CRDEntry[] = [
  ...
  },
  {
    ...
    styleTag: "Classic",
    mascot: "Stomper",
    imagePath: "/lovable-uploads/c9d8e7f6-a5b4-4c3d-9e2f-1a8b7c6d5e4f.png",
    rarity: "Epic",
    powerLevel: 90,
  ...
  },
  {
    ...
    imagePath: "/lovable-uploads/f9e8d7c6-b5a4-4f3e-8d2c-1a9b8c7d6e5f.png",
    rarity: "Legendary",
    powerLevel: 95,
  ...
  // These can be re-added when actual logo files are uploaded
  {
    ...
    imagePath: "/lovable-uploads/placeholder-pit-bby.png", // Need actual UUID path
    rarity: "Uncommon",
    powerLevel: 73,
    unlockMethod: "achievement",
    collectibility: 78,
  ...
  },
  {
    ...
    imagePath: "/lovable-uploads/placeholder-crd-gradient.png", // Need actual UUID path
    rarity: "Mythic",
    powerLevel: 100,
    unlockMethod: "legacy",
    collectibility: 100,
  ...
  },
  {
    ...
    imagePath: "/lovable-uploads/placeholder-uni-ybb.png", // Need actual UUID path
    rarity: "Common",
    powerLevel: 55,
    unlockMethod: "starter",
    collectibility: 60,
  ...
  },
  {
    ...
    imagePath: "/lovable-uploads/placeholder-uni-wrb.png", // Need actual UUID path
    rarity: "Uncommon",
    powerLevel: 58,
    unlockMethod: "starter",
    collectibility: 65,
  ...
  },
  {
    ...
    secondaryColor: "#000000",
    styleTag: "Jersey",
    imagePath: "/lovable-uploads/placeholder-uni-bb.png", // Need actual UUID path
    rarity: "Common",
    powerLevel: 52,
    unlockMethod: "starter",
    collectibility: 58,
  ...
  },
  {
    ...
    imagePath: "/lovable-uploads/placeholder-old-rs.png", // Need actual UUID path
    rarity: "Legendary",
    powerLevel: 94,
    unlockMethod: "legacy",
    collectibility: 97,
  ...
  },
  {
    ...
    imagePath: "/lovable-uploads/c6d7e8f9-a1b2-4c3d-9e4f-6a7b8c9d1e2f.png",
    rarity: "Epic",
    powerLevel: 89,
    unlockMethod: "special",
    collectibility: 93,
  ...
  },
  {
    ...
    imagePath: "/lovable-uploads/a2b3c4d5-e6f7-4a8b-9c1d-4e5f6a7b8c9d.png",
    rarity: "Rare",
    powerLevel: 78,
    unlockMethod: "achievement",
    collectibility: 82,
  ...
  },
  {
    ...
    styleTag: "Sketch",
    notes: "Artistic/alternate",
    imagePath: "/lovable-uploads/b4c5d6e7-f8a9-4b1c-8d2e-5f6a7b8c9d1e.png",
    rarity: "Rare",
    powerLevel: 76,
    unlockMethod: "achievement",
    collectibility: 80,
